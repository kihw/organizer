...
class WindowManagerV2 {
  constructor() {
    ...
    console.log('WindowManagerV2: Initialized with OPTIMIZED activation methods');
  }
  ...
  initializeOptimizedActivationMethods() {
    ...
    console.log('WindowManagerV2: Initialized 4 OPTIMIZED activation methods with shorter timeouts');
  }
  ...
  async getDofusWindows() {
    ...
    try {
      ...
      console.log('WindowManagerV2: Starting REAL detection with optimized timeout...');
  ...
  async performRealDetection() {
    try {
      console.log('WindowManagerV2: Performing OPTIMIZED platform detection...');
  ...
  async activateWindow(windowId) {
    ...
    try {
      console.log(`WindowManagerV2: OPTIMIZED activation for ${windowId}`);
      ...
      for (const method of this.activationMethods) {
        try {
          console.log(`WindowManagerV2: Trying ${method.name} for ${windowId} (timeout: ${method.timeout}ms)...`);
  ...
  cleanup() {
    ...
    try {
      ...
      console.log('WindowManagerV2: OPTIMIZED system cleaned up');
